					...
					<form method="POST" id="form">
						<?php
							...
							if (mysqli_num_rows($result) >= 1) {
								...
								<h2 style="font-size: 15px; color: #cfcfcf; text-align: center; margin-top: 0; margin-bottom: 30px;">Nenhum token disponivel, aguarde a organiza&ccedil;&atilde;o gerar um novo token, e atualize a pagina</h2> <?php
							}
						?>
						<?php
